...
namespace Branching
{
    class Program
    {
...

        {
            ...
            string result = favNum == 12 ? "You have an awesome favorite number!" : "You do not have an awesome favoite number.";
            ...
            //else
            //{
            //    Console.WriteLine("uhhhhhhhhhhh...something went wrong.");
            //}
